...
Группа уходит от «Саша + хэды в Amo» к **одному group Sales (Лёня) под CRO**. Сейчас хэды сами пишут свою тёплую; Лёня активирует **свою** базу; дальше — гипотезы (FMCG, топ-30/100) с CRO.
...
См. `client_pools.json` и HTML. Не колл-лист для перехвата.

## Источники

- `00_Inbox/tg_exports_june_2026/export_tg_группа_продажи_2026_06.md`
- `artifact_cult_group_rules_and_vision_2026_06.md`
- `artifact_cult_group_commercial_rules_full_2026_06_16.md`
- `artifact_cult_group_clifton_team_interaction_map_2026_05_12.md`
- `blaster/sales/artifact_sasha_alekseev_motivation_handoff_full_2026_06_18.md`
- `note_cult_group_july_2026_plan_sales_onboarding.md`
- Meetings 07–08.05 / 08.06.2026
